...
using System.Collections.Specialized;
    ...
    /// </summary>
class GetOpt {
	private static GetOpt singleInstance=null;
	private StringCollection scArgs=null;
	...
	/// <param name="args"></param>
	/// <param name="opts"></param>
	private void parseOptions(string[] args,string opts) {
	...
	/// </summary>
	///
	private int optIndInternal { get { return optInd; }}

	/// <summary>
	///
	/// </summary>
	private string optArgInternal { get { return optArg; }}
}