...
namespace NSLS {
	...
	abstract class CmdLineParameter : ICmdLineParameter {
		...
		protected CmdLineParameter(char aChar,string aLongArg,string helpMsg) {
			_key=aChar.ToString();
			_longKey=aLongArg;
			_helpText=helpMsg;
		}
	...
	class SwitchParameter : CmdLineParameter {
		...
		#region CTOR
		public SwitchParameter(char aChar,string aLongArg,string helpMsg) : this(aChar,aLongArg,helpMsg,false) { _sel=false; }
		public SwitchParameter(char aChar,string aLongArg,string helpMsg,bool currValue) : base(aChar,aLongArg,helpMsg) { _sel=currValue; }
		#endregion
	...
	class StringParameter : CmdLineParameter {
		...
		#region CTOR
		public StringParameter(char aChar,string aLongArg,string argName,string helpMsg) : this(aChar,aLongArg,argName,helpMsg,string.Empty) { }

		public StringParameter(char aChar,string aLongArg,string argName,string helpMsg,string currValue)
			: base(aChar,aLongArg,helpMsg) {
